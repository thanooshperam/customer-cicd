    ...
    stages {
        ...
        stage('Validate Deployment') {
            ...
            steps {
                ...
                bat "docker inspect ${env.APP_CONTAINER}"

                bat "docker inspect ${env.DB_CONTAINER}"

                bat "curl http://localhost:${env.HOST_PORT}/health"

                bat "curl http://localhost:${env.HOST_PORT}/db-health"
            }
        }
